...
public class PayDemoActivity extends FragmentActivity {
    ...
    TextView productSubjectTV,productBodyTV,productPriceTV;
    String productSubject,productBody;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pay_main);
        productPrice = getIntent().getDoubleExtra("price",0);
        productSubject = getIntent().getStringExtra("subject");
        productBody = getIntent().getStringExtra("body");
        productSubjectTV= (TextView) findViewById(R.id.product_subject);
        productBodyTV= (TextView) findViewById(R.id.product_body);
        productPriceTV= (TextView) findViewById(R.id.product_price);
        productPriceTV.setText(productPrice+"");
        productBodyTV.setText(productBody);
        productSubjectTV.setText(productSubject);
    ...
    public void pay(View v) {
        ...
        // 订单 需要设置为直接的信息
//
        String orderInfo = getOrderInfo(productSubject,//商品名称
                                productBody,//商品描述
                                Double.toString(productPrice));                //商品价格
